...
<body class="bg-light">
  ...
  <div id="menuDropdown" class="menu-dropdown text-start">
    <button class="btn btn-primary" onclick="window.location.href='index.php?c=Todos&m=form'">🏠 Home</button>
    <button class="btn btn-primary" onclick="window.location.href='index.php?c=Todos&m=calories'">🔥 Calories Calculator</button>
    <button class="btn btn-primary" onclick="window.location.href='index.php?c=Todos&m=track'">🌍 Carbon Track</button>
  </div>
